...
public class HCwithPerp2 {
    ...
    public HCwithPerp2(TopicDistributions Phi, Prior Alpha, Perplexity perplexity , String root, boolean averageAlpha, int GroupMaxMinSize) {
        this.Phi = Phi;
        this.Alpha = Alpha;
        this.T = Phi.length();
    ...
    public void evaluate(int s) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        for(int size=1; size<= maxSize; size++) {
            ...
            if (keys.size()>1) {
                ...
                System.out.println("minimum cluster size "+size+"("+ keys.size()+"topics:"+perp);
