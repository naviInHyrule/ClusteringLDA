...
public class PerpSeqExe {
    ...
    public static void main(String[] args) throws java.io.IOException{
        ...
        if(line.hasOption("Alg")){
            ...
            System.err.println("perplexity Algorithm: 1 for Particle, ow for Sequential");
        }
        ...
        Perplexity perp = new Perplexity(teCorpus, R, root, PerplexityType);
