...
public class OLDAExe {

  public static void main(String[] args) throws IOException {

    if (args.length != 8) {
      System.out.println("Usage: OLDAExe <instances> <num_topics> <num_itns> <print_interval> <save_sample_interval> <symmetric> <optimize> <output_dir>");
      System.exit(1);
    }
    ...
    OLDA2 OLDA = new OLDA2();

    //OLDA.estimate(docs, T, alpha, beta, numItns, printInterval, saveSampleInterval, symmetric, optimize, documentTopicsFile, topicWordsFile, stateFile, alphaFile, betaFile, logProbFile, hyperparamFile);
