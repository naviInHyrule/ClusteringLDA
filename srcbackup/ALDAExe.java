...
public class ALDAExe {
    ...
    public static void main(String[] args) throws java.io.IOException{
        ...
        double alphaSum = alpha * T; //by HW definition alpha_t = alpha/T
        double betaSum = beta *W; //by HW definition beta_w = alpha/W
        ...
        LDA2 lda = new LDA2();
        lda.estimate(trCorpus, voc, T, alphaSum, betaSum, numItns,burnItns,lag,root,true);
